 ...
 *
 */
class AppStoreConnectITCReportApi
{

    const APP_STORE_CONNECT_SALES_ENDPOINT   = 'https://reportingitc-reporter.apple.com/reportservice/sales/v1';
    const APP_STORE_CONNECT_FINANCE_ENDPOINT = 'https://reportingitc-reporter.apple.com/reportservice/finance/v1';
    ...
    /**
     * App Store Connect access token
     *
     * @var string
     ...
     * @var boolean
     */
    private $_endpoint = self::APP_STORE_CONNECT_SALES_ENDPOINT;
    ...
    /**
     * AppStoreConnectITCReportApi constructor.
     ...
     * @return AppStoreConnectITCReportApi
     */
     ...
     * set report mode
     *
     * @param $mode $string AppStoreConnectITCReportApi::REPORT_MODE_ALL or AppStoreConnectITCReportApi::REPORT_MODE_EARNING_ONLY
     * @return AppStoreConnectITCReportApi
     */
